...
IRFS['P8_TRANSIENT020E']    = IRF('P8_TRANSIENT020E' ,'P8R2_TRANSIENT020E_V6' ,'302',     8, galactic, 'isotropic_transient_r020_4years_P8V4_rev3.txt')
IRFS['P8_TRANSIENT020']     = IRF('P8_TRANSIENT020' ,'P8R2_TRANSIENT020_V6'  ,'302',    16, galactic, 'isotropic_transient_r020_4years_P8V4_rev3.txt')
IRFS['P8_TRANSIENT010E']    = IRF('P8_TRANSIENT010E' ,'P8R2_TRANSIENT010E_V6' ,'302',    32, galactic, 'isotropic_transient_r010_4years_P8V4_rev3.txt')
IRFS['P8_TRANSIENT010']     = IRF('P8_TRANSIENT010' ,'P8R2_TRANSIENT010_V6'  ,'302',    64, galactic, 'isotropic_transient_r010_4years_P8V4_rev3.txt')
IRFS['P8_SOURCE']           = IRF('P8_SOURCE'        ,'P8R2_SOURCE_V6'       ,'302',   128, galactic, 'isotropic_source_4years_P8V3.txt')
IRFS['P8_CLEAN']            = IRF('P8_CLEAN'         ,'P8R2_CLEAN_V6'       ,'302',   256, galactic, 'isotropic_clean_4years_P8V3.txt')
IRFS['P8_ULTRACLEAN']       = IRF('P8_ULTRACLEAN' ,'P8R2_ULTRACLEAN_V6'    ,'302',   512, galactic, 'isotropic_ultraclean_4years_P8V3.txt')
IRFS['P8_ULTRACLEANVETO']   = IRF('P8_ULTRACLEANVETO','P8R2_ULTRACLEANVETO_V6','302',  1024, galactic, 'isotropic_ultraclean_4years_P8V3.txt')
IRFS['P8_TRANSIENT100S']    = IRF('P8_TRANSIENT100S' ,'P8R2_TRANSIENT100S_V6' ,'302', 32768, galactic, 'isotropic_transient_r020_4years_P8V4_rev3.txt') # YOU SHOULD USE THE BKGE FOR THIS 
IRFS['P8_TRANSIENT015S']    = IRF('P8_TRANSIENT015S' ,'P8R2_TRANSIENT015S_V6' ,'302', 65536, galactic, 'isotropic_transient_r020_4years_P8V4_rev3.txt')
